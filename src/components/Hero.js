...
const Hero = () => {
      ...
      <div className="hero-text-wrapper">
        <div className="hero-right">
          ...
          <p className="hero-paragraph">
            I’m a passionate self taught frontend web developer, I enjoy
            building projects with Html/css, javascript and frameworks like
            react and gatsby.{" "}
          </p>
        </div>
        <div>
  ...
  */}
      ...
      <div className="hero-btn-wrapper">
        <a href="#projects">
          <button className="hero-btn-work btn">See work</button>
        </a>
        <a
          href="https://docs.google.com/document/d/1Ko6HcsyS0QgToOn32kOKlAMvG4l16YYiHCDv_mPz7ek/edit?usp=sharing"
          target="_blank"
          rel="noreferrer"
        >
